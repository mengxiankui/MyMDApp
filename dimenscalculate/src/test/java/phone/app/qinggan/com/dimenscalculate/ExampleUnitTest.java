package phone.app.qinggan.com.dimenscalculate;
...
public class ExampleUnitTest {
    ...
    public static void gen() {
        ...
        File file = new File("./values/dimens.xml");//这里如果找不到,使用绝对路径即可
...
//            String sw480file = "./src/main/res/values-sw480dp-land/dimens.xml";
//            String sw600file = "./app/src/main/res/values-sw600dp-land/dimens.xml";
            String sw720file = "./values-1280x720/dimens.xml";
