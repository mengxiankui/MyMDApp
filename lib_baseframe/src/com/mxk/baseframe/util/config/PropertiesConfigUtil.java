 ...
 */
package com.mxk.baseframe.util.config;
 ...
 * @version V1.0
 */
public class PropertiesConfigUtil implements IConfig
{
	/** assets中配置信息文件 */
	private String assetsPath = "/assets/config.properties";
	/** 软件Files文件夹中配置信息文件 */
	private String filesPath = "config.properties";
	private static PropertiesConfigUtil mPropertiesConfig;
	private static final String LOADFLAG = "assetsload";
	private Context mContext;
	private Properties mProperties;

	private PropertiesConfigUtil(Context context)
	{
	 ...
	 * @return
	 */
	public static PropertiesConfigUtil getPropertiesConfig(Context context)
	{
		if (mPropertiesConfig == null)
		{
			mPropertiesConfig = new PropertiesConfigUtil(context);
		}
	...
	public void loadConfig()
	{
		...
		InputStream in = PropertiesConfigUtil.class
