...
public class RefreshListLoading extends MyLoadingLayoutBase
{
    ...
    public RefreshListLoading(Context paramContext, AttributeSet paramAttributeSet)
    {
        ...
        init(paramContext, MyScrollViewBase.ScrollMode.PULL_FROM_END);
        setAnimation();
    }

    public RefreshListLoading(Context paramContext,
            MyScrollViewBase.ScrollDirection paramScrollDirection,
            MyScrollViewBase.ScrollMode paramScrollMode)
    {
        super(paramContext, paramScrollDirection, paramScrollMode);
        init(paramContext, mScrollMode);
        setAnimation();
    }
    ...
    private void init(Context paramContext, MyScrollViewBase.ScrollMode paramScrollMode)
    {
        ...
        {
            pullToRefresh = paramContext
                    .getString(R.string.refresh_list_loading_pullToRefresh);
            refreshing = paramContext
                    .getString(R.string.refresh_list_loading_refreshing_from_end);
        }
        ...
        {
            localLayoutParams.height = Display.getPixel(getContext(), 63.0F);
    ...
    public void reset()
    {
        if (mScrollMode == MyScrollViewBase.ScrollMode.PULL_FROM_START)
        {
            refreshImage.setVisibility(View.VISIBLE);
            mContainer.setVisibility(View.VISIBLE);
        }
